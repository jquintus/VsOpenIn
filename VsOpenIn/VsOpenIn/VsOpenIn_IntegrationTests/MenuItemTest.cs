...
namespace VsOpenIn_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(MasterDevs.VsOpenIn.GuidList.guidVsOpenInCmdSet, (int)MasterDevs.VsOpenIn.PkgCmdIDList.cmdidOpenInVim);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "VsOpenIn", "MasterDevs.VsOpenIn.VsOpenInPackage");
