...
using MasterDevs.VsOpenIn;

namespace VsOpenIn_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VsOpenInPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(MasterDevs.VsOpenIn.GuidList.guidVsOpenInCmdSet, (int)MasterDevs.VsOpenIn.PkgCmdIDList.cmdidOpenInVim);
